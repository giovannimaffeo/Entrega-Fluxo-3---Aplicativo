        ...
        return(
                ...
                <View style = {styles.post} >
                        ...
                        <View style={styles.fotoPerfil}>
                                ...
                                source={{ uri: 'https://pbs.twimg.com/profile_images/563843814725402624/Vb8k670S_400x400.png'}}  />
                        ...
                        <View style={styles.textoCompleto}>
                                ...
                                <View style={styles.identificacao}>
                                        ...
                                        <View>
                                                <Text style={styles.letrasIdentificacao}>
                                                        {props.nomeCompleto} 
                                                </Text>
                                        </View>

                                        <View>
                                                <Text style={styles.letrasArroba}>
                                                        @{props.userName}
                                                </Text>
                                        </View>
